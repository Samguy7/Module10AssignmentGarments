...
/**
 * Class for Party Garments
 *
 * @author sam
 */
public class PartyGarmentStore extends GarmentStore{
     ...
     * @param styleShoe 
     */
    public PartyGarmentStore(String topName, String pantsName,String shoeName, 
   ...
   @Override
    public String toString() {
        return "\n\nParty Garment Attire" + getTopName() + "\npantsName: " + getPantsName() +
